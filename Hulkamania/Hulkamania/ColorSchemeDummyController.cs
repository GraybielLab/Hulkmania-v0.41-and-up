...
namespace Brandeis.AGSOL.Hulkamania
{
    ...
    /// </summary>
    public sealed class ColorSchemeDummyController : ColorScheme
    {
        #region Base Colors

        // Color scheme "Solarized" by Ethan Schoonover.

        private static readonly Color Base03 = Color.FromArgb(0, 54, 37);
        private static readonly Color Base02 = Color.FromArgb(7, 66, 47);
        private static readonly Color Base01 = Color.FromArgb(88, 117, 109);
        private static readonly Color Base00 = Color.FromArgb(101, 131, 123);
        private static readonly Color Base0 = Color.FromArgb(131, 150, 142);
        private static readonly Color Base1 = Color.FromArgb(147, 161, 154);
